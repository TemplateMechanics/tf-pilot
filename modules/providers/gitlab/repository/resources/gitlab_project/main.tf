resource "gitlab_project" "this" {
  ...
  # Nested block 'container_expiration_policy' is schema-supported.
  # Provide a value via var.block_container_expiration_policy and expand this template as needed.

  # Nested block 'push_rules' is schema-supported.
  # Provide a value via var.block_push_rules and expand this template as needed.
