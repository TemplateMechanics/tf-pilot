resource "gitlab_group" "this" {
  ...
  # Nested block 'default_branch_protection_defaults' is schema-supported.
  # Provide a value via var.block_default_branch_protection_defaults and expand this template as needed.
