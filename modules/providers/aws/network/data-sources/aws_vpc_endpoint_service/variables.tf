...
variable "block_filter" {
  description = "Optional nested block 'filter' for type 'aws_vpc_endpoint_service'."
  type        = any
  default     = null
}

variable "block_timeouts" {
  description = "Optional nested block 'timeouts' for type 'aws_vpc_endpoint_service'."
  type        = any
  default     = null
}
