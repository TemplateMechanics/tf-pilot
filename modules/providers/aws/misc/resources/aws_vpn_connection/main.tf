...
resource "aws_vpn_connection" "this" {
  ...
  dynamic "tunnel1_log_options" {
    for_each = var.tunnel1_log_options == null ? [] : (can(tolist(var.tunnel1_log_options)) ? tolist(var.tunnel1_log_options) : [var.tunnel1_log_options])
    content {}
  }
  dynamic "tunnel2_log_options" {
    for_each = var.tunnel2_log_options == null ? [] : (can(tolist(var.tunnel2_log_options)) ? tolist(var.tunnel2_log_options) : [var.tunnel2_log_options])
    content {}
  }
}
