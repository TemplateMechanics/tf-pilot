...
resource "aws_neptune_cluster" "this" {
  ...
  dynamic "serverless_v2_scaling_configuration" {
    for_each = var.serverless_v2_scaling_configuration == null ? [] : (can(tolist(var.serverless_v2_scaling_configuration)) ? tolist(var.serverless_v2_scaling_configuration) : [var.serverless_v2_scaling_configuration])
    content {}
  }
  dynamic "timeouts" {
