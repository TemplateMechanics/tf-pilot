...
variable "mesh_owner" {
  description = "Optional attribute 'mesh_owner' for type 'aws_appmesh_virtual_gateway'."
  type        = any
  default     = null
}
...
variable "tags_all" {
  description = "Optional attribute 'tags_all' for type 'aws_appmesh_virtual_gateway'."
  type        = any
  default     = null
}

variable "spec" {
  description = "Top-level nested block 'spec' payload for type 'aws_appmesh_virtual_gateway'."
  type        = any
  default     = null
}
