...
variable "transit_gateway_connect_id" {
  description = "Optional attribute 'transit_gateway_connect_id' for type 'aws_ec2_transit_gateway_connect'."
  type        = any
  default     = null
}

variable "filter" {
  description = "Top-level nested block 'filter' payload for type 'aws_ec2_transit_gateway_connect'."
  type        = any
  default     = null
}
