...
variable "name" {
  description = "Optional attribute 'name' for type 'aws_connect_routing_profile'."
  type        = any
  default     = null
}

variable "routing_profile_id" {
  description = "Optional attribute 'routing_profile_id' for type 'aws_connect_routing_profile'."
  type        = any
  default     = null
}
