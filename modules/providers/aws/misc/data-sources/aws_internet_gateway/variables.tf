...
variable "internet_gateway_id" {
  description = "Optional attribute 'internet_gateway_id' for type 'aws_internet_gateway'."
  type        = any
  default     = null
}
...
variable "filter" {
  description = "Top-level nested block 'filter' payload for type 'aws_internet_gateway'."
  type        = any
  default     = null
}
