...
# Provider: aws
# Module: misc/data-sources/aws_alb_target_group
# File: variables.tf
...
variable "arn" {
  description = "Optional attribute 'arn' for type 'aws_alb_target_group'."
  type        = any
  default     = null
}
...
variable "timeouts" {
  description = "Top-level nested block 'timeouts' payload for type 'aws_alb_target_group'."
  type        = any
  default     = null
}
