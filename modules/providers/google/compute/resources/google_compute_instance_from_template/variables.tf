...
variable "block_advanced_machine_features" {
  description = "Optional nested block 'advanced_machine_features' for type 'google_compute_instance_from_template'."
  type        = any
  default     = null
}

variable "block_attached_disk" {
  description = "Optional nested block 'attached_disk' for type 'google_compute_instance_from_template'."
  type        = any
  default     = null
}

variable "block_boot_disk" {
  description = "Optional nested block 'boot_disk' for type 'google_compute_instance_from_template'."
  type        = any
  default     = null
}

variable "block_confidential_instance_config" {
  description = "Optional nested block 'confidential_instance_config' for type 'google_compute_instance_from_template'."
  type        = any
  default     = null
}

variable "block_guest_accelerator" {
  description = "Optional nested block 'guest_accelerator' for type 'google_compute_instance_from_template'."
  type        = any
  default     = null
}

variable "block_instance_encryption_key" {
  description = "Optional nested block 'instance_encryption_key' for type 'google_compute_instance_from_template'."
  type        = any
  default     = null
}

variable "block_network_interface" {
  description = "Optional nested block 'network_interface' for type 'google_compute_instance_from_template'."
  type        = any
  default     = null
}

variable "block_network_performance_config" {
  description = "Optional nested block 'network_performance_config' for type 'google_compute_instance_from_template'."
  type        = any
  default     = null
}

variable "block_params" {
  description = "Optional nested block 'params' for type 'google_compute_instance_from_template'."
  type        = any
  default     = null
}

variable "block_reservation_affinity" {
  description = "Optional nested block 'reservation_affinity' for type 'google_compute_instance_from_template'."
  type        = any
  default     = null
}

variable "block_scheduling" {
  description = "Optional nested block 'scheduling' for type 'google_compute_instance_from_template'."
  type        = any
  default     = null
}

variable "block_scratch_disk" {
  description = "Optional nested block 'scratch_disk' for type 'google_compute_instance_from_template'."
  type        = any
  default     = null
}

variable "block_service_account" {
  description = "Optional nested block 'service_account' for type 'google_compute_instance_from_template'."
  type        = any
  default     = null
}

variable "block_shielded_instance_config" {
  description = "Optional nested block 'shielded_instance_config' for type 'google_compute_instance_from_template'."
  type        = any
  default     = null
}

variable "block_timeouts" {
  description = "Optional nested block 'timeouts' for type 'google_compute_instance_from_template'."
  type        = any
  default     = null
}
