...
# Provider: google
# Module: observability/resources/google_logging_organization_bucket_config
# File: variables.tf
...
variable "cmek_settings" {
  description = "Top-level nested block 'cmek_settings' payload for type 'google_logging_organization_bucket_config'."
  type        = any
  default     = null
}

variable "index_configs" {
  description = "Top-level nested block 'index_configs' payload for type 'google_logging_organization_bucket_config'."
  type        = any
  default     = null
}
