...
variable "block_cmek_settings" {
  description = "Optional nested block 'cmek_settings' for type 'google_logging_billing_account_bucket_config'."
  type        = any
  default     = null
}

variable "block_index_configs" {
  description = "Optional nested block 'index_configs' for type 'google_logging_billing_account_bucket_config'."
  type        = any
  default     = null
}
