...
resource "google_compute_region_instance_group_manager" "this" {
  ...
  dynamic "instance_flexibility_policy" {
    for_each = var.instance_flexibility_policy == null ? [] : (can(tolist(var.instance_flexibility_policy)) ? tolist(var.instance_flexibility_policy) : [var.instance_flexibility_policy])
    content {}
  }
