...
variable "data" {
  description = "Optional attribute 'data' for type 'google_composer_user_workloads_secret'."
  type        = any
  default     = null
}
...
variable "timeouts" {
  description = "Top-level nested block 'timeouts' payload for type 'google_composer_user_workloads_secret'."
  type        = any
  default     = null
}
