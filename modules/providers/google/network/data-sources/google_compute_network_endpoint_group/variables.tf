...
variable "name" {
  description = "Optional attribute 'name' for type 'google_compute_network_endpoint_group'."
  type        = any
  default     = null
}
...
variable "self_link" {
  description = "Optional attribute 'self_link' for type 'google_compute_network_endpoint_group'."
  type        = any
  default     = null
}
