...
variable "block_additional_capabilities" {
  description = "Optional nested block 'additional_capabilities' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}

variable "block_admin_ssh_key" {
  description = "Optional nested block 'admin_ssh_key' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}

variable "block_automatic_instance_repair" {
  description = "Optional nested block 'automatic_instance_repair' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}

variable "block_automatic_os_upgrade_policy" {
  description = "Optional nested block 'automatic_os_upgrade_policy' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}

variable "block_boot_diagnostics" {
  description = "Optional nested block 'boot_diagnostics' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}

variable "block_data_disk" {
  description = "Optional nested block 'data_disk' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}

variable "block_extension" {
  description = "Optional nested block 'extension' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}

variable "block_gallery_application" {
  description = "Optional nested block 'gallery_application' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}

variable "block_identity" {
  description = "Optional nested block 'identity' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}

variable "block_network_interface" {
  description = "Optional nested block 'network_interface' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}

variable "block_os_disk" {
  description = "Optional nested block 'os_disk' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}

variable "block_plan" {
  description = "Optional nested block 'plan' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}

variable "block_rolling_upgrade_policy" {
  description = "Optional nested block 'rolling_upgrade_policy' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}

variable "block_scale_in" {
  description = "Optional nested block 'scale_in' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}

variable "block_secret" {
  description = "Optional nested block 'secret' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}

variable "block_source_image_reference" {
  description = "Optional nested block 'source_image_reference' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}

variable "block_spot_restore" {
  description = "Optional nested block 'spot_restore' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}

variable "block_termination_notification" {
  description = "Optional nested block 'termination_notification' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}

variable "block_timeouts" {
  description = "Optional nested block 'timeouts' for type 'azurerm_linux_virtual_machine_scale_set'."
  type        = any
  default     = null
}
