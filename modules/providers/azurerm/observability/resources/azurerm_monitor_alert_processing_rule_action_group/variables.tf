...
variable "condition" {
  description = "Top-level nested block 'condition' payload for type 'azurerm_monitor_alert_processing_rule_action_group'."
  type        = any
  default     = null
}

variable "schedule" {
  description = "Top-level nested block 'schedule' payload for type 'azurerm_monitor_alert_processing_rule_action_group'."
  type        = any
  default     = null
}

variable "timeouts" {
  description = "Top-level nested block 'timeouts' payload for type 'azurerm_monitor_alert_processing_rule_action_group'."
  type        = any
  default     = null
}
