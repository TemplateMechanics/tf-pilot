...
variable "location" {
  description = "Required attribute 'location' for type 'azurerm_data_share_account'."
  type        = any
}
...
variable "tags" {
  description = "Optional attribute 'tags' for type 'azurerm_data_share_account'."
  type        = any
  default     = null
}

variable "identity" {
  description = "Top-level nested block 'identity' payload for type 'azurerm_data_share_account'."
  type        = any
  default     = null
}
