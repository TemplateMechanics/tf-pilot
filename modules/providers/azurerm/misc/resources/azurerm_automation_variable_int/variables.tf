...
# Provider: azurerm
# Module: misc/resources/azurerm_automation_variable_int
# File: variables.tf
...
variable "description" {
  description = "Optional attribute 'description' for type 'azurerm_automation_variable_int'."
  type        = any
  default     = null
}

variable "encrypted" {
  description = "Optional attribute 'encrypted' for type 'azurerm_automation_variable_int'."
  type        = any
  default     = null
}

variable "value" {
  description = "Optional attribute 'value' for type 'azurerm_automation_variable_int'."
  type        = any
  default     = null
}
