...
variable "retention_period_in_days" {
  description = "Required attribute 'retention_period_in_days' for type 'azurerm_oracle_autonomous_database_backup'."
  type        = any
}

variable "type" {
  description = "Optional attribute 'type' for type 'azurerm_oracle_autonomous_database_backup'."
  type        = any
  default     = null
}
