...
variable "resource_group_name" {
  description = "Required attribute 'resource_group_name' for type 'azurerm_private_dns_zone'."
  type        = any
}
...
variable "soa_record" {
  description = "Top-level nested block 'soa_record' payload for type 'azurerm_private_dns_zone'."
  type        = any
  default     = null
}
