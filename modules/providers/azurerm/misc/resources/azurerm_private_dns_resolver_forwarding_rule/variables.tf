...
variable "domain_name" {
  description = "Required attribute 'domain_name' for type 'azurerm_private_dns_resolver_forwarding_rule'."
  type        = any
}
...
variable "resource_enabled" {
  description = "Optional attribute 'enabled' for type 'azurerm_private_dns_resolver_forwarding_rule'."
  type        = any
  default     = null
}

variable "metadata" {
  description = "Optional attribute 'metadata' for type 'azurerm_private_dns_resolver_forwarding_rule'."
  type        = any
  default     = null
}

variable "target_dns_servers" {
  description = "Top-level nested block 'target_dns_servers' payload for type 'azurerm_private_dns_resolver_forwarding_rule'."
  type        = any
  default     = null
}
