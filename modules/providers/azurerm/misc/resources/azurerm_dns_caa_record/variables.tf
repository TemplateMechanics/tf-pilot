...
# Provider: azurerm
# Module: misc/resources/azurerm_dns_caa_record
# File: variables.tf
...
variable "ttl" {
  description = "Required attribute 'ttl' for type 'azurerm_dns_caa_record'."
  type        = any
}
...
variable "tags" {
  description = "Optional attribute 'tags' for type 'azurerm_dns_caa_record'."
  type        = any
  default     = null
}

variable "record" {
  description = "Top-level nested block 'record' payload for type 'azurerm_dns_caa_record'."
  type        = any
  default     = null
}
