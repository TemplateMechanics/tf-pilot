...
variable "profile_name" {
  description = "Required attribute 'profile_name' for type 'azurerm_cdn_frontdoor_origin_group'."
  type        = any
}

variable "resource_group_name" {
  description = "Required attribute 'resource_group_name' for type 'azurerm_cdn_frontdoor_origin_group'."
  type        = any
}
