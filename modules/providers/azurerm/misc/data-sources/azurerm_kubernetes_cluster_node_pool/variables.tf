...
variable "kubernetes_cluster_name" {
  description = "Required attribute 'kubernetes_cluster_name' for type 'azurerm_kubernetes_cluster_node_pool'."
  type        = any
}
...
variable "resource_group_name" {
  description = "Required attribute 'resource_group_name' for type 'azurerm_kubernetes_cluster_node_pool'."
  type        = any
}
