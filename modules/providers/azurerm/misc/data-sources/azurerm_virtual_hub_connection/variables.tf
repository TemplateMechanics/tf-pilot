...
variable "resource_group_name" {
  description = "Required attribute 'resource_group_name' for type 'azurerm_virtual_hub_connection'."
  type        = any
}

variable "virtual_hub_name" {
  description = "Required attribute 'virtual_hub_name' for type 'azurerm_virtual_hub_connection'."
  type        = any
}
