...
variable "cognitive_account_name" {
  description = "Required attribute 'cognitive_account_name' for type 'azurerm_cognitive_account_project'."
  type        = any
}
...
variable "resource_group_name" {
  description = "Required attribute 'resource_group_name' for type 'azurerm_cognitive_account_project'."
  type        = any
}
