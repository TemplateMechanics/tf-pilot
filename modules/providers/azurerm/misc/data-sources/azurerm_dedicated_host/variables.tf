...
variable "dedicated_host_group_name" {
  description = "Required attribute 'dedicated_host_group_name' for type 'azurerm_dedicated_host'."
  type        = any
}
...
variable "resource_group_name" {
  description = "Required attribute 'resource_group_name' for type 'azurerm_dedicated_host'."
  type        = any
}
