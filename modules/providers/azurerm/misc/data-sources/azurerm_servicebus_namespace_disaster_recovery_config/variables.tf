...
variable "namespace_id" {
  description = "Optional attribute 'namespace_id' for type 'azurerm_servicebus_namespace_disaster_recovery_config'."
  type        = any
  default     = null
}

variable "namespace_name" {
  description = "Optional attribute 'namespace_name' for type 'azurerm_servicebus_namespace_disaster_recovery_config'."
  type        = any
  default     = null
}

variable "resource_group_name" {
  description = "Optional attribute 'resource_group_name' for type 'azurerm_servicebus_namespace_disaster_recovery_config'."
  type        = any
  default     = null
}
