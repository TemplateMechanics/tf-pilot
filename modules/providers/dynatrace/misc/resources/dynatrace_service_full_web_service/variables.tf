...
variable "conditions" {
  description = "Top-level nested block 'conditions' payload for type 'dynatrace_service_full_web_service'."
  type        = any
  default     = null
}

variable "id_contributors" {
  description = "Top-level nested block 'id_contributors' payload for type 'dynatrace_service_full_web_service'."
  type        = any
  default     = null
}
