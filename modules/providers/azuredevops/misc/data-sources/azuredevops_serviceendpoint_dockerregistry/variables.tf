...
variable "service_endpoint_id" {
  description = "Optional attribute 'service_endpoint_id' for type 'azuredevops_serviceendpoint_dockerregistry'."
  type        = any
  default     = null
}

variable "service_endpoint_name" {
  description = "Optional attribute 'service_endpoint_name' for type 'azuredevops_serviceendpoint_dockerregistry'."
  type        = any
  default     = null
}
