...
variable "authentication_basic" {
  description = "Top-level nested block 'authentication_basic' payload for type 'azuredevops_serviceendpoint_visualstudiomarketplace'."
  type        = any
  default     = null
}

variable "authentication_token" {
  description = "Top-level nested block 'authentication_token' payload for type 'azuredevops_serviceendpoint_visualstudiomarketplace'."
  type        = any
  default     = null
}

variable "timeouts" {
  description = "Top-level nested block 'timeouts' payload for type 'azuredevops_serviceendpoint_visualstudiomarketplace'."
  type        = any
  default     = null
}
