resource "github_repository" "this" {
  ...
  # Nested block 'pages' is schema-supported.
  # Provide a value via var.block_pages and expand this template as needed.

  # Nested block 'security_and_analysis' is schema-supported.
  # Provide a value via var.block_security_and_analysis and expand this template as needed.
