...
- **100% reflected coverage across 9 providers** — AWS, Azure, GCP, Helm, Kubernetes, and 4 others all generate complete module families for every resource and data source type. See [`docs/PROVIDER-COVERAGE-COMPLETION.md`](docs/PROVIDER-COVERAGE-COMPLETION.md).
