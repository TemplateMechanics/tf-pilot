...
|---|---|---:|---:|
| dynatrace | changed | 306/0/0 | 27/0/0 |
...
- Data source types added
  ...
  - dynatrace_application_detection_rules
  - dynatrace_attack_alerting
  - dynatrace_aws_credentials
  - dynatrace_aws_iam_external
  - dynatrace_aws_supported_services
  - dynatrace_azure_credentials
  - dynatrace_azure_supported_services
  - dynatrace_calculated_service_metric
  - dynatrace_credentials
  - dynatrace_entities
  - dynatrace_entity
  - dynatrace_failure_detection_parameters
  - dynatrace_host
  - dynatrace_hub_extension_v2_active_version
  - dynatrace_hub_extension_v2_latest_version
  - dynatrace_hub_items
  - dynatrace_lambda_agent_version
  - dynatrace_mobile_application
  - dynatrace_process
  - dynatrace_process_group
  - dynatrace_remote_environments
  - dynatrace_request_attribute
  - dynatrace_request_naming
  - dynatrace_service
