...
1. Always use Terraform MCP first for provider/module/schema/state context, then route to provider MCPs (`azure`, `aws`, `awsDocumentation`, `context7`) based on active providers.
